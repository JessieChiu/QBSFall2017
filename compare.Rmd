...
Find significant predictors of Model 1 with summary. As shown below, predictor **Bx1_c** is the most significant, and hence we will examine **the effect of movie type - "Crime-inducing"** on **log crime cases**.
...
```{r m1.average}
# Model 1
Bx1_c.seq <- seq(from=-5.5, to=4, length.out = 30)
d.predict <- list(
  log_crime = rep(0,30),
  Bx1_c = Bx1_c.seq,
  Bx2_c = rep(0,30),
  ...
  plot( log_crime ~ Bx1_c , d , col=rangi2 )
  lines( Bx1_c.seq , mu , lty=2 )
  lines( Bx1_c.seq, mu.PI[1,] , lty=2 )
  lines( Bx1_c.seq , mu.PI[2,] , lty=2 )
